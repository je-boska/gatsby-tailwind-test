...
const Feature = () => {
  return (
    <div className='mt-16 px-8 md:grid md:grid-cols-2 max-w-7xl mx-auto'>
      <div className='p-8 text-7xl text-center md:text-left'>
        Build
        <br />
        Anything
      </div>
      <div className='p-8 text-2xl rounded-xl'>
        ...
        far faster, easier, and safer than ever before.
      </div>
    </div>
  )
}
